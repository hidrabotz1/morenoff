const ownerNumber = ["556496484726@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '556496484726' 
// mude para seu numero

const callbotmsgs = ['ff', 'moreno']
...
const antinewchatmsg = 'Olá, sou o bot de WhatsApp e meu criador proibiu de números novos me chamarem no privado, irei te bloquear caso seja injusto contate meu dono.'
//mensagem do antinewchat

const urlaudiomenu = 'https://i.top4top.io/m_2062ksxwj0.mp3'
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO MORENO-FF-BOT COM 434 COMANDOS, BATERIA: ${battery}`
}
...
const cr = '🔥卍 𝑴𝑶𝑹𝑬𝑵𝑶 𝑭𝑭 𝑩𝑶𝑻 卍🔥\n' 
// texto do simbolo de verificado

const prefix = '!' 
// prefixo

const blockedmsg = '*Seu número esta bloqueado, ou seja não irei lhe obedecer*'
...
+ 'FN:Moreno FF\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=556496484726:+55 64 9648-4726\n' 
+ 'END:VCARD'
